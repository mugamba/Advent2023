...
var filtered = listOfAll.Select(o => 
new
{
    Red = o.Sets.Max(g => g.Red),
    Blue = o.Sets.Max(g => g.Blue),
    Green = o.Sets.Max(g => g.Green)
}).ToList();



Console.WriteLine(filtered.Select(o => o.Red * o.Blue * o.Green).Sum());
Console.ReadKey();
